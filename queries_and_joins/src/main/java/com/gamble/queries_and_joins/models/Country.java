...
public class Country {
	...
	public Country(String code, String name, String continent, String region, float surface_area, int indep_year,
			int population, float life_expentency, float gnp, float gnp_old, String local_name, String government_form,
			String head_of_state, int capital, String code2, List<Language> languages, List<City> cities) {
		super();
		this.code = code;
		this.name = name;
		...
		this.life_expectancy = life_expentency;
		this.gnp = gnp;
